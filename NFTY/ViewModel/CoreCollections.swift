...
let CCB_Contract = UrlCollectionContract(name: "Crypto Cannabis Club", address: "0x80a4B80C653112B789517eb28aC111519b608b19", baseUri: "https://api.cryptocannabisclub.com/image/")
...
let CompositeCollection = CompositeRecentTradesObject([
  ...
  CompositeRecentTradesObject.CollectionInitializer(
    info:CollectionInfo(
      ...
      collectionColor:Color.black,
      disableRecentTrades:false,
      similarTokens : nil,//SimilarTokensGetter(label:"NFToker") { tokenId in CypherCity_nearestTokens[safe:Int(tokenId)] },
      rarityRanking : nil//RarityRankingImpl(CypherCity_rarityRanks)
    ),
